        ...
        for task in tasks:
            ...
            try:
                if status == 'completed':
                    ...
                    markup.add(
                        InlineKeyboardButton("📢 Разместить в канале AL BI Chart", callback_data=f"post_{task_id}"),
