...
async def download_and_cut_audio(url, duration=45):
    """
    Скачивает MP3 файл и обрезает до указанной длительности

    Args:
        url: URL MP3 файла
        duration: Длительность в секундах (по умолчанию 45)
    ...
    try:
        ...
        keyboard = InlineKeyboardMarkup(inline_keyboard=[
            [InlineKeyboardButton(
                text="🔓 Разблокировать полные версии (300₽)",
        ...
        await bot.send_message(
            ...
            text="💎 **Что можно сделать с этой песней:**\n\n" +
                 ...
                 "🎤 **Караоке** — версия без вокала для исполнения\n" +
                 "🎸 **Кавер** — перепой в другом стиле/жанре\n" +
                 "📢 **В канал** — опубликуй в нашем официальном канале\n" +
