...
from celery_tasks import celery_app, generate_music_task, generate_song_task
...
async def handle_song_examples(message: types.Message):
    markup = InlineKeyboardMarkup(row_width=1)
    markup.add(
